...
dependencies {
    ...
    api(project(":components:observability"))
...
val apiSpecPath = "${findProperty("open.api.directory.public")}user_commands_api.yaml"
...
tasks.openApiGenerate {
    ...
    setProperty(
        "configOptions", mapOf(
            ...
            "reactive" to "true",
            "packageName" to "com.klimek.langsapp.service.user.commands.generated",
            "modelPackage" to "com.klimek.langsapp.service.user.commands.generated"
        )
    )
}
